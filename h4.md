...
Kurssi: Linux-palvelimet kevät 2026
...
- [1. Palvelimen hankinta ja domain (kohta a)](#1-palvelimen-hankinta-ja-domain-kohta-a)
- [2. Palomuuri (kohta d)](#2-palomuuri-kohta-d)
- [3. Kotisivut palvelimelle (kohta e)](#3-kotisivut-palvelimelle-kohta-e)
- [4. Ohjelmien päivitys (kohta f)](#4-ohjelmien-päivitys-kohta-f)
...
## Vuokraa oma palvelin

Vuokrasin itselleni oman palvelimen Suomalaiselta UpCloud-yritykseltä. ( https://upcloud.com )

Rekisteröityminen oli helppoa ja liittymistarjouksena sain 250€ krediittejä palveluun

![Upcloud dashboard](upcloud_dash.png)

Valitsin palvelusta uuden palvelimen ja käyttöjärjestelmäksi Debian 13. Yksi ydin ja 1GB RAM-muistia riittää tarpeisiini tällä hetkellä. Palvelu maksaa 3€/kk.

![Upcloud server](upcloud.png)

## SSH-avain

Loin itselleni SSH-avaimen jota palveluntarjoaja(UpCloud) käyttää tunnistaakseen minut. Se oli hyvin yksinkertaista kun oppi mitä tehdä.

Komennolla ``` ssh keygen ``` sain luotua itselleni avaimen. **TÄRKEÄÄ** oli löytää public-key jotai voi huoletta jakaa vaikka omalla kotisivullaan. Jos salaisen avaimen vahingossa vuotaisin nettiin pitäisi minun tehdä uusi ja päivittää se kaikkiin palveluihin joissa kyseistä avainta käytän.


## Virtuaalipalvelimeni alkutoimet

Otin yhteyden omaan palvelimeeni ssh-yhteydellä komennolla
```
ssh root@10.10.10.10 # Palvelimen ip-osoite löytyy palveluntarjoajalta
```
Tein toimenpiteet mitkä on kerrottu aiemmin tässä dokumentissa kohdassa [2. Palomuuri (kohta d)](#2-palomuuri-kohta-d) & [3. Kotisivut palvelimelle (kohta e)](#3-kotisivut-palvelimelle-kohta-e)

![ufw portit](ufw_portit.png)

Kokeilin sivujen toimivuutta syöttämällä palvelimen ip-osoitteen selaimen osoitekenttään 

![Kotisivut](kotisivut.png)
...
Grok.com -tekoälyä käytetty ulkoasun muokkaamiseen
