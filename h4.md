...
- [1. Palvelimen hankinta ja domain (kohdat a)](#1-palvelimen-hankinta-ja-domain-kohdat-a)
- [2. Palomuuri (kohdat d)](#2-palomuuri-kohdat-d)
- [3. Kotisivut palvelimelle (kohdat e)](#3-kotisivut-palvelimelle-kohdat-e)
- [4. Ohjelmien päivitys (kohdat f)](#4-ohjelmien-päivitys-kohdat-f)
...
## 3. Kotisivut palvelimelle (kohdat e)
```
